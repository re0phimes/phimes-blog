...
- 名称：`Phimes`
- 描述：`在 AI 时代思考与分享`
- 地址：`https://blog.phimes.top/`
- 头像：`https://blog.phimes.top/images/logo/logo.webp`
- 订阅：`https://blog.phimes.top/rss.xml`

```yml
name: Phimes
desc: 在 AI 时代思考与分享
url: https://blog.phimes.top/
avatar: https://blog.phimes.top/images/logo/logo.webp
rss: https://blog.phimes.top/rss.xml
```
