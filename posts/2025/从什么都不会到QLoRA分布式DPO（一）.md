...
![image.png](https://image.phimes.top/img/20250221231539.webp)


**第二件事**：用nvcc --version确认你的cuda版本
![image.png](https://image.phimes.top/img/20250221231626.webp)

**第三件事**：确认你的pytorch版本
![image.png](https://image.phimes.top/img/20250221231722.webp)
...
![image.png](https://image.phimes.top/img/202502181127120.webp)
...
![image.png](https://image.phimes.top/img/202502181356026.webp)
...
![image.png](https://image.phimes.top/img/202502181355805.webp)

我们之前设置的输出路径是`./output`，那么到项目根路径下，就能看到这个checkpoint了。

![image.png](https://image.phimes.top/img/202502181358357.webp)
...
运行之后，你就会在命令行里看到：
![image.png](https://image.phimes.top/img/20250223204936.webp)
