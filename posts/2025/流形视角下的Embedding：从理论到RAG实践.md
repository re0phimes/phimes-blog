...
> [!question] 那么离国王更近的那堆向量都是什么意思？或者说这个空间下的所有向量，都有意义么？
...
> [!note] 对这个定义中出现的关键数学概念解释，有基础就跳过这些概念的部分吧。
...
> [!question] 为什么当我们使用LoRA微调的时候，只需要一些高质量的数据，这个量级非常小了？
...
> [!question] 当我们量化一个原本是fp32的模型到int4以后，为什么它依然在某些任务上效果不错？
